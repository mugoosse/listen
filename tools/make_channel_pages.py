...
<div class="bar">
  <div class="page">
    <div class="bar-inner">
      ...
      <a class="button small primary" href="https://github.com/mugoosse/listen/releases/latest/download/Listen.dmg" data-rybbit-event="mac_download_clicked">Download</a>
    </div>
  </div>
</div>
...
<header class="hero" id="top">
  <div class="page">
    ...
    <div class="buttons" id="buttons">
      <a class="button primary" href="https://github.com/mugoosse/listen/releases/latest/download/Listen.dmg" data-rybbit-event="mac_download_clicked">Download for macOS</a>
    ...
    <div class="chipcheck" id="chipcheck" hidden>
      ...
      <a href="https://github.com/mugoosse/listen/releases/latest/download/Listen.dmg" data-rybbit-event="mac_download_clicked">download
