    ...
    private func build() {
        ...
        NSLayoutConstraint.activate([
            ...
            warning.leadingAnchor.constraint(equalTo: devicePicker.trailingAnchor,
                                             constant: 10),
            // Out to the strips' own edge. This used to stop short of a model
            // pull-down on the right, and with that gone the sentence about the
            // microphone gets the whole width, which is the one thing on this
            // row somebody actually has to read mid-call.
